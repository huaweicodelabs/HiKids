...
import com.huawei.hikidskt.transactors.ImageClassificationTransactor
...
@HiltViewModel
class LiveClassificationViewModel  @Inject constructor(
    ...
    private var mImageClassificationTransactor = ImageClassificationTransactor()

    private lateinit var mLensEngine: LensEngine

    private lateinit var mAnalyzer: MLImageClassificationAnalyzer
    ...
    private fun addSurfaceViews() {
        ...
        val surfaceViewOverlay = SurfaceView(mContext).also {
            ...
            mImageClassificationTransactor.setOverlay(mSurfaceHolderOverlay, typeface)
        }
    ...
    private fun createAnalyzer() {
        mAnalyzer = MLAnalyzerFactory.getInstance().localImageClassificationAnalyzer
        mAnalyzer.setTransactor(mImageClassificationTransactor)
    }
